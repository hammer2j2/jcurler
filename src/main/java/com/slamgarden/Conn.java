...
/** Description of Conn()
 *
 * A Conn is used to make an entry point into one of the package modules without calling
...
public class Conn
{
    ...
    public static void main(String args[]) throws IOException, InterruptedException, ConnectionPoolTimeoutException, ExecutionException, HttpException {
        ...
        logger.debug("This is debug in Conn()");
        ...
        while(httpline.next() ) {
          ...
          if(!curHost.equals(lastHost)) { // changed destination
            ...
            try {
              ...
              System.out.println("Caught connection error in Conn()");
