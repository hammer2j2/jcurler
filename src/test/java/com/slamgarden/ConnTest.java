...
public class ConnTest {
    ...
    static String curHost = null;
    static String lastHost = "";
    static String filename = System.getProperty("ConnTestFile");

    private static Logger logger = Logger.getLogger(ConnTest.class);

    public ConnTest() throws IOException, InterruptedException, ConnectionPoolTimeoutException, ExecutionException, HttpException { 
    }

@Test
    public void RunTest() throws IOException, InterruptedException, ConnectionPoolTimeoutException, ExecutionException, HttpException { 

        httpline = new HttpLine(filename);
        ...
        while(httpline.next() ) {
          ...
          if(!curHost.equals(lastHost)) { // changed destination
            ...
            try {
              ...
              System.out.println("Caught connection error in TestConn()");
